...
Installing "Monolith Vacancies" can be done either by searching for "Monolith Vacancies" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
